...
const AddSong: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newSong: Song = {
      ...
      distrokidHyperFollowLink: formData.distrokidHyperFollowLink,
      musixmatchLink: formData.musixmatchLink,
      youtubeMusicLink: formData.youtubeMusicLink,
  ...
  return (
    <div className="max-w-4xl mx-auto pb-12 px-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
             <label className="text-[10px] text-slate-500 font-black uppercase tracking-widest">DistroKid & Media Links</label>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input name="distrokidHyperFollowLink" className="bg-slate-900 border border-brand-gold/50 text-brand-gold px-4 py-3 text-xs focus:border-brand-gold outline-none font-mono" value={formData.distrokidHyperFollowLink} onChange={handleChange} placeholder="DistroKid HyperFollow Link (Required)" />
        ...
        <div className="space-y-2">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <input name="genre" className="bg-slate-900 border border-white/10 px-4 py-3 text-white text-xs focus:border-brand-accent outline-none" value={formData.genre} onChange={handleChange} placeholder="Genre" />
                <div className="flex flex-col gap-2">
                    <label className="flex items-center gap-2 cursor-pointer bg-slate-900 border border-white/10 p-2">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer bg-slate-900 border border-white/10 p-2">
                         ...
                         <span className="text-[10px] text-white font-bold uppercase">Explicit Content</span>
                    </label>
                </div>
             </div>
        </div>
