...
const AdminDashboard: React.FC = () => {
  const { songs, updateSong, addSong, deleteSong, playSong, currentSong, importData } = useData();
        ...
        <div className="lg:col-span-8 space-y-10">
            <div className="bg-slate-900/50 border border-white/5 rounded-xl overflow-hidden shadow-2xl">
                <div className="px-8 py-6 bg-white/5 border-b border-white/5 flex justify-between items-center">
                    <h2 className="text-xs font-black text-white uppercase tracking-[0.3em]">Asset List</h2>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-white/5">
                            <tr>
                                ...
                                <th className="p-4 text-[9px] font-black text-slate-500 uppercase tracking-widest">Metadata</th>
                                <th className="p-4 text-[9px] font-black text-slate-500 uppercase tracking-widest">Links Status</th>
                                ...
                                <tr key={song.id} className="hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="p-4">
                                        <div className="flex gap-2">
                                            {song.musicBrainzId ? <span title="MusicBrainz Linked" className="w-2 h-2 rounded-full bg-green-500"></span> : <span title="No MBID" className="w-2 h-2 rounded-full bg-red-900"></span>}
                                            {song.lyrics ? <span title="Lyrics Present" className="text-[8px] border border-slate-600 px-1 text-slate-400">LYR</span> : null}
                                        </div>
                                    </td>
                                    <td className="p-4">
                                        <div className="flex gap-2 text-xs">
                                            <span title="Spotify" className={song.spotifyLink ? 'opacity-100' : 'opacity-20 grayscale'}>🟢</span>
                                            <span title="Apple Music" className={song.appleMusicLink ? 'opacity-100' : 'opacity-20 grayscale'}>🍎</span>
                                            <span title="YouTube" className={song.youtubeMusicLink || song.youtubeUrl ? 'opacity-100' : 'opacity-20 grayscale'}>▶️</span>
                                            <span title="KKBOX" className={song.kkboxLink ? 'opacity-100' : 'opacity-20 grayscale'}>🟦</span>
                                        </div>
                                    </td>
